...
type OnSelectHandler func(ctx context.Context, bot *bot.Bot, callbackQuery *models.CallbackQuery, date time.Time)
type OnCancelHandler func(ctx context.Context, bot *bot.Bot, callbackQuery *models.CallbackQuery)
...
func defaultOnCancel(_ context.Context, _ *bot.Bot, _ *models.CallbackQuery) {}
